...
function perishablePress_7G_request_method() {
	...
	return perishablePress_7G_get_patterns($string, $match,"bad-method");
...
function perishablePress_7G_query_string() {
	...
	return perishablePress_7G_get_patterns($string, $match,"bad-query");
...
function perishablePress_7G_request_uri() {
	...
	return perishablePress_7G_get_patterns($string, $match,"bad-request");
...
function perishablePress_7G_user_agent() {
	...
	return perishablePress_7G_get_patterns($string, $match,"bad-agent");
...
function perishablePress_7G_ip_address() {
	...
	return perishablePress_7G_get_patterns($string, $match,"bad-ip");
...
function perishablePress_7G_remote_host() {
	...
	return perishablePress_7G_get_patterns($string, $match,"bad-host");
...
function perishablePress_7G_http_referrer() {
	...
	return perishablePress_7G_get_patterns($string, $match,"bad-referrer");
